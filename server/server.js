var AIAssistant, BanIP, BuildManager, Content, DB, FileStorage, RateLimiter, Session, WebApp, WebSocket, compression, cookieParser, express, fs, morgan, path, process,
...
this.Server = (function() {
  ...
  Server.prototype.start = function(app, db) {
    ...
    this.ai_assistant = new AIAssistant(this);
