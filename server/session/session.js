...
this.Session = (function() {
  function Session(server, socket) {
    ...
    this.register("ai_assist", (function(_this) {
      return function(msg) {
  ...
  Session.prototype.aiAssist = function(data) {
    if (this.user == null) {
      return this.sendError("not connected", data.request_id);
    }
    return this.server.ai_assistant.assist(this.user, data, (function(_this) {
      return function(result) {
        if (result.error != null) {
          return _this.sendError(result.error, data.request_id);
        } else {
          return _this.send({
            name: "ai_assist",
            text: result.text,
