this.Publish = (function() {
  function Publish(app) {
    ...
    this.app.appui.setAction("verified-request-button", (function(_this) {
      return function() {
        return _this.requestVerification();
      };
    })(this));
  ...
  Publish.prototype.updateVerified = function() {
    var flags, project;
    ...
    flags = project.flags || {};
    document.getElementById("publish-verified-section").style.display = project["public"] ? "block" : "none";
    document.getElementById("publish-verified-badge").style.display = flags.verified ? "block" : "none";
    document.getElementById("publish-verified-pending").style.display = flags.verification_requested && !flags.verified ? "block" : "none";
    return document.getElementById("verified-request-button").style.display = project["public"] && !flags.verified && !flags.verification_requested ? "inline-block" : "none";
  };

  Publish.prototype.requestVerification = function() {
    ...
    return this.app.client.sendRequest({
      ...
      return function(msg) {
        if (msg.name !== "error" && (_this.app.project != null) && msg.id === _this.app.project.id) {
          _this.app.project.flags = msg.flags;
          return _this.updateVerified();
        }
      };
    })(this));
  };
